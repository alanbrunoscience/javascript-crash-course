 ...
 * user to enter some text. Users will sometimes, by accident, enter an empty space character at the beginning or the end 
 * of a text box.
 * 
 * - Say, for example, you ask the user for their name, and they enter " Sam" instead of "Sam". This could cause issues in 
 * some scenarios (for example, email addresses).
 * 
