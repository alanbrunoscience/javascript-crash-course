 ...
 * Slug
 * 
 * - In computer science, a slug is a string used to identify a certain item. Oftentimes, this slug is used in the URL for Search
 * Engine Optimization and better user experience. Let's say you've got a product called: "Easy assembly dining table". We cannot
 * use this name in the URL bar because it contains spaces (it won't look nice, for example https://example.com/item/Easy assembly
 * dining table). This is why we use a slug that looks like this:
 * 
 ...
 * 
 * 1. The slug should not be more than 15 characters. When there are more than 15 characters, ignore everything after the 15th 
 * character.
 * 
