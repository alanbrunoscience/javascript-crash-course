 ...
 * signature (number = 0) which is why we get back 1 from the function. See how we were able to prevent NaN without 
 * adding an if condition?
 * 
 * Also, notice how addOne(2) still works as before. So, when you do provide an argument, the default parameter is 
 * ignored.
 * 
