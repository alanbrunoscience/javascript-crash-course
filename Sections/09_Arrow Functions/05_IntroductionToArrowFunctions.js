 ...
 * 
 * (Just to let you know, functions are not deprecated. It is preferable that you use arrow functions because of their benefits.)
 * 
 ...
 * 
 * - There are multiple ways of writing a function in JavaScript. You could either define a function and give it a name, or you could 
 * define a variable and assign it to an anonymous function. So the following function:
 * 
 * function sum(a, b) {
 *   return a + b;
 * }
 ...
 * }
 * 
 * - Notice how we define a variable 'sum' and then we assign it to a function that takes 2 parameters 'a' and 'b'. Now, let's convert that 
