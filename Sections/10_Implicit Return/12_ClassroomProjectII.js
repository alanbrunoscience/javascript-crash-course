 ...
 * 
 * - This is the classroom project but you have to use arrow functions (optional: implicit return)!
 * You can enter grades in the browser tab and add them to the app, which will show you various
 * statistics about the classroom. For example, you will see the average grade, all the failing 
 * grades, etc.
 * 
