 ...
 * 
 * - There are no tasks and no tests in this challenge. All you have to do is visualize in the console the value
 * of 'total', 'current', and 'finally' the 'sum'. Notice how:
 * 
 ...
 * 
 * - Feel free to change the numbers in the grades array and check the output in the console to better understand 
 * how '.reduce()' works.
 */
